...
import SingleteacherActivity from './SingleteacherActivity';
        ...
        <section className="container mt-5">
            ...
            <div className="row ">
                ...
                <div className="col-sm-6 col-md-8">
                    ...
                    <div className='text-center mt-4'><Link to='/addactivity' className='btn btn-primary'>একটিভিটি যোগ করুন</Link></div>
